...
export function createMemoryStores(): InitializedStores {
  ...
  function saveKeyIndex(record: ApiKeyRecord): void {
  ...
  function saveRegistryIndex(record: RegistrySchemaRecord): void {
  ...
  function saveJobIndex(record: GenerateJobRecord): void {
